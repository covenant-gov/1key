...
declare module '$env/static/private' {
	...
	export const npm_package_scripts_test_aztec_nr: string;
	...
	export const npm_package_scripts_build_tauri: string;
	...
	export const npm_package_scripts_dev_aztec: string;
	export const npm_config_registry: string;
	export const npm_package_devDependencies__sveltejs_kit: string;
	export const npm_package_private: string;
	export const npm_package_scripts_test_aztec_js: string;
	...
	export const npm_package_scripts_install: string;
	...
	export const npm_package_engines_yarn: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_scripts_test_aztec_nr: string;
		NODE: string;
		INIT_CWD: string;
		NVM_CD_FLAGS: string;
		...
		npm_package_scripts_build_tauri: string;
		...
		npm_package_scripts_dev_aztec: string;
		npm_config_registry: string;
		npm_package_devDependencies__sveltejs_kit: string;
		npm_package_private: string;
		npm_package_scripts_test_aztec_js: string;
		...
		INFOPATH: string;
		npm_package_engines_yarn: string;
