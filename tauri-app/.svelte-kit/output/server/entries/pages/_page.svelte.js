import"clsx";import{U as m}from"../../chunks/index-client.js";class d{constructor(t,e={}){this.container=document.getElementById(t),this.options={length:6,onComplete:null,onInput:null,placeholder:"•",...e},this.boxes=[],this.currentIndex=0}render(){this.container.innerHTML=`
